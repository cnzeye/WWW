...
$(document).ready(function(){
	...
	// $('.shide').find('li').eq(0).css('background-color','#5c60b8');
	// $('.shide').find('li').eq(1).css('background-color','#5cb8a6');
	// $('.shide').find('li').eq(2).css('background-color','#5c60b8');
	// $('.shide').find('li').eq(3).css('background-color','#5cb8a6');
	// $('.shide').find('li').eq(4).css('background-color','#5c60b8');
	// $('.shide').find('li').eq(5).css('background-color','#5cb8a6');
	/*鼠标滑过li效果*/
